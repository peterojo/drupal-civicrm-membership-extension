...
$civicrm_root = '/www/compucorp/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/www/compucorp/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost/compucorp/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '595d787cd0a4463f1702a7c6fc681620');
}
...
// define( 'CIVICRM_MAIL_LOG', '/www/compucorp/sites/default/files/civicrm/templates_c//mail.log');
// }
